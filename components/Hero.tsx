...
export default function Hero() {
  return (
    <section className="grid min-h-[calc(100svh-80px)] w-full grid-cols-1 md:grid-cols-2">

      {/* Shop All */}
      <a
  href="/rugs"
  className="group relative min-h-[50svh] overflow-hidden md:min-h-[calc(100svh-80px)]"
>
        <Image
...
>
  <source
    src="/images/collections/rug.mp4"
    type="video/mp4"
  />
</video>
